...
public class Tokenize
{
	public static void main( String[] args)
	{
		...
		String expr="4+5-12/3.5-5.4*3.14*777"; // replace with any expression to test
		System.out.println( "expr: " + expr );
		ArrayList<String> operatorList = new ArrayList<String>();
		ArrayList<String> operandList = new ArrayList<String>();
		// StringTokenizer is like an infile and calling .hasNext()
		StringTokenizer st = new StringTokenizer( expr,"+-*/", true );//take opreators out, if put false will only get numebrs
		while (st.hasMoreTokens())//use it as a string, take out
		{
